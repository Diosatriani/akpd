...
import com.bersama.databasefirebase.Adapter.AdapterBarangRecyclerView;
...
public class ReadActivity extends AppCompatActivity implements AdapterBarangRecyclerView.FirebaseDataListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        database.child("barang").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                 ...
                 */
                adapter = new AdapterBarangRecyclerView(daftarBarang, ReadActivity.this);
    ...
    public void onDeleteData(Barang barang, int position) {
        ...
        if(database!=null){            database.child("barang").child(barang.getKey()).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                Toast.makeText(ReadActivity.this,"success delete", Toast.LENGTH_LONG).show();
            }
        });
